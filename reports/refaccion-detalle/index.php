...
// Los shared partials esperan $metricaUnidad y $metricaTitulo vía $meta.
// Añadimos las keys que usan kpis.php y table.php.
$meta['modo']              = $modo;
$meta['metricaTitulo']     = $metricaTitulo;
$meta['metricaUnidad']     = $metricaUnidad;
$meta['mostrarProduccion'] = false;
$meta['ratioHeader']       = $modo === 'costo' ? 'Costo promedio ($)' : 'Consumo semanal';
...
*/
$isGrupo        = false;
$urlVolverIndex = '../refacciones-criticas/index.php';
