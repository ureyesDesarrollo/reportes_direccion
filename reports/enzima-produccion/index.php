...
|--------------------------------------------------------------------------
| Los parciales viejos suelen esperar 'quimicos'
|--------------------------------------------------------------------------
*/
...
$productoLabel = null; // no aplica para grupos
?>
<!DOCTYPE html>
<html lang="es">
...
<head>
  ...
  <style>
    body.page-loading> :not(.loading-overlay) {
      visibility: hidden;
    }
...
<body class="page-loading">
  <div class="loading-overlay active" id="pageLoader">
  ...
  <script>
    window.reportConfig = {
      ...
      grupoActual: <?= json_encode($grupoActual, JSON_UNESCAPED_UNICODE) ?>,
