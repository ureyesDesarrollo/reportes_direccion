...
$shipmentStatusClass = static function ($status): string {
  ...
  if (in_array($normalized, ['COMPLETADA', 'COMPLETADO'], true)) return 'status-completed';
    ...
    <div class="dashboard">
      ...
      <div class="pending-grid" aria-label="Apartados pendientes de definir">
        <section class="section mix-section monitor-panel<?= $initialView === 'revolturas' ? ' is-active' : '' ?>" data-view="revolturas">
          ...
          <div class="mix-table-wrap"><table class="mix-table"><colgroup><col style="width:10%"><col style="width:7%"><col style="width:8%"><col style="width:7%"><col style="width:7%"><col style="width:8%"><col style="width:8%"><col style="width:6%"><col style="width:5%"><col style="width:7%"><col style="width:6%"><col style="width:8%"><col style="width:7%"><col style="width:6%"></colgroup><thead><tr><th>Folio</th><th>Bloom</th><th>Viscosidad</th><th>Malla 30</th><th>Malla 45</th><th>Transp.</th><th>% Transm.</th><th>Color</th><th>Olor</th><th>Redox</th><th>pH</th><th>Conduct.</th><th>Humedad</th><th>Cenizas</th></tr></thead><tbody>
            <?php foreach ($mixes as $mix): ?><tr><td><?= $e($mix['folio'] ?? '—') ?></td><td class="<?= $e($cellClass($mix, 'bloom')) ?>"><?= $e($compactNumber($mix['bloom'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'viscosidad')) ?>"><?= $e($compactNumber($mix['viscosidad'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'malla_30')) ?>"><?= $e($compactNumber($mix['malla_30'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'malla_45')) ?>"><?= $e($compactNumber($mix['malla_45'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'transparencia')) ?>"><?= $e($compactNumber($mix['transparencia'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'transmitancia')) ?>"><?= $e($compactNumber($mix['transmitancia'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'color')) ?>"><?= $e($compactNumber($mix['color'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'olor')) ?>"><?= $e($compactNumber($mix['olor'] ?? null, 0)) ?></td><td class="<?= $e($cellClass($mix, 'redox')) ?>"><?= $e($compactNumber($mix['redox'] ?? null, 3)) ?></td><td class="<?= $e($cellClass($mix, 'ph')) ?>"><?= $e($compactNumber($mix['ph'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'conductividad')) ?>"><?= $e($compactNumber($mix['conductividad'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'humedad')) ?>"><?= $e($compactNumber($mix['humedad'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'cenizas')) ?>"><?= $e($compactNumber($mix['cenizas'] ?? null)) ?></td></tr><?php endforeach; ?>
          </tbody></table></div>
          <?php endif; ?>
        </section>
        <section class="section completed-section monitor-panel<?= $initialView === 'terminadas' ? ' is-active' : '' ?>" data-view="terminadas">
          ...
          <div class="mix-table-wrap"><table class="mix-table"><colgroup><col style="width:10%"><col style="width:7%"><col style="width:8%"><col style="width:7%"><col style="width:7%"><col style="width:8%"><col style="width:8%"><col style="width:6%"><col style="width:5%"><col style="width:7%"><col style="width:6%"><col style="width:8%"><col style="width:7%"><col style="width:6%"></colgroup><thead><tr><th>Folio</th><th>Bloom</th><th>Viscosidad</th><th>Malla 30</th><th>Malla 45</th><th>Transp.</th><th>% Transm.</th><th>Color</th><th>Olor</th><th>Redox</th><th>pH</th><th>Conduct.</th><th>Humedad</th><th>Cenizas</th></tr></thead><tbody>
            <?php foreach ($completedMixes as $mix): ?><tr><td><?= $e($mix['folio'] ?? '—') ?></td><td class="<?= $e($cellClass($mix, 'bloom')) ?>"><?= $e($compactNumber($mix['bloom'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'viscosidad')) ?>"><?= $e($compactNumber($mix['viscosidad'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'malla_30')) ?>"><?= $e($compactNumber($mix['malla_30'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'malla_45')) ?>"><?= $e($compactNumber($mix['malla_45'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'transparencia')) ?>"><?= $e($compactNumber($mix['transparencia'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'transmitancia')) ?>"><?= $e($compactNumber($mix['transmitancia'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'color')) ?>"><?= $e($compactNumber($mix['color'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'olor')) ?>"><?= $e($compactNumber($mix['olor'] ?? null, 0)) ?></td><td class="<?= $e($cellClass($mix, 'redox')) ?>"><?= $e($compactNumber($mix['redox'] ?? null, 3)) ?></td><td class="<?= $e($cellClass($mix, 'ph')) ?>"><?= $e($compactNumber($mix['ph'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'conductividad')) ?>"><?= $e($compactNumber($mix['conductividad'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'humedad')) ?>"><?= $e($compactNumber($mix['humedad'] ?? null)) ?></td><td class="<?= $e($cellClass($mix, 'cenizas')) ?>"><?= $e($compactNumber($mix['cenizas'] ?? null)) ?></td></tr><?php endforeach; ?>
          </tbody></table></div>
          <?php endif; ?>
        </section>
